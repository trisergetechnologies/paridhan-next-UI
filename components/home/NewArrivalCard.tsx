...
export type NewArrivalCardProduct = Omit<
...
export default function NewArrivalCard({ product }: { product: NewArrivalCardProduct }) {
  ...
  return (
    <Link
      ...
      prefetch={false}
      className={cn(
        "group/na flex h-full min-h-0 w-full min-w-0 flex-col outline-none",
      ...
      >
        {imageUrl && !imageFailed ? (
          <Image
            ...
            alt=""
            fill
            className="object-cover transition-transform duration-500 ease-out group-hover/na:scale-[1.03]"
